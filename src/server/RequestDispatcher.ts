...
export class RequestDispatcher {
  ...
  constructor(
    ...
    this.requestProcessor = new RequestProcessor()
      ...
      .addHandler('/games/launch/', new GameLaunchRequestHandler(gameRegistry, gameLibrary, gameTaskRunner))
      .addHandler('/games/stop/', new GameStopRequestHandler(gameRegistry, gameTaskRunner))
